...
namespace Finbourne.Insights.Sdk.Extensions.Tests
{
    ...
    {
        private const string APP = "INSIGHTS";
        private string _secretsFile;
        private string _cachedTokenUrl;
        private string _cachedInsightsUrl;
        ...
        public void Setup()
        {
            ...
            _cachedInsightsUrl = Environment.GetEnvironmentVariable($"FBN_{APP}_API_URL") ??
        ...
        public void TearDown()
        {
            ...
            Environment.SetEnvironmentVariable($"FBN_{APP}_API_URL", _cachedInsightsUrl);
        ...
        public void Use_Secrets_File_If_It_Exists()
        {
            PopulateDummySecretsFile(new Dictionary<string, string>
            {
                ...
                {"insightsUrl", string.Format("<{0}Url>", "insights")},
            });            
            ...
            Assert.That(apiConfiguration.InsightsUrl, Is.EqualTo(string.Format("<{0}Url>", "insights")));            
        }
        [Test]
        ...
        public void Use_Environment_Variables_If_No_Secrets_File_Provided()
        {
            ...
            Environment.SetEnvironmentVariable($"FBN_{APP}_API_URL", string.Format("<env.{0}Url>", "insights"));
            ...
            Assert.That(apiConfiguration.InsightsUrl, Is.EqualTo(string.Format("<env.{0}Url>", "insights")));            
        }
        [Test]
        ...
        public void Use_Configuration_Section_If_Supplied()
        {
            var settings = new Dictionary<string, string>
            {
                ...
                { "api:InsightsUrl", string.Format("<env.{0}Url>", "insights") },
        ...
        public void Throw_Exception_If_Configuration_Section_Incomplete()
        {
            ...
            {
                { "api:TokenUrl", "<tokenUrl>" },
                { "api:InsightsUrl", string.Format("<{0}Url>", "insights") },
                { "api:ClientId", "<clientId>" },
                { "api:ClientSecret", "" },
                { "api:Username", "<username>" },
                { "api:Password", "" },
